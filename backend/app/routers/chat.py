...
async def query(query: Query) -> QueryResponse:
    """
    the flow of query: 1. get the original question as a Query object 2. convert the question into a vector and find
    the closest vectors based on the file credentials by query the vector DB 4. retrieve the sentences and thier's
    context in the text 5. engineer proper prompt and send to openAI API
    """
    ...
    try:
        ...
        for vector_data in top_k_closest_vectors:
            ...
            context_query = VectorContextQuery(user_id=user_id, document_id=cur_vec_doc_id,
        ...
        prompt_prefix = "Please generate response based solely on the information I provide in this text. Do not " \
                        "reference any external knowledge or provide additional details beyond what I have given."
