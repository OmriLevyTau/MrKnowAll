      ...
      >
        ...
        >
          <div style={{display:"flex", flexDirection:"column", position:"relative"}}>
            <div style={{alignItems: "center", fontFamily:"Nunito, sans-serif", fontSize: "180%", }} >
          ...
          <div>
            <div className="new-home-header-search" style={{ display:"flex", flexDirection:"column", alignItems:"center", position:"relative"}}>                    
                <h3  style={{color:'black', fontWeight:'700' , fontFamily: "Nunito, sans-serif"}} ></h3>
                <ChatInput width={"80%"} />
            </div>
          </div>
